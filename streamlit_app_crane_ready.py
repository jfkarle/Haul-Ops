# ECM Scheduler — Final with Official Ramp Labels and Sunday Block
...
if submitted:
    ...
    for offset in range(45):
        ...
        # Enforce weekday rule — skip all Sundays, allow Saturday only in May & September
        if day.weekday() == 6:
            continue
        ...
        for truck, jobs in st.session_state.TRUCKS.items():
            ...
            for slot in valid_slots:
                ...
                if not conflict:
                    ...
                    # J17 logic — only if not already booked at a different ramp
